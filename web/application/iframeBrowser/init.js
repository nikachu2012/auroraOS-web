(() => {
    const softwareName = 'iframeBrowser' // SoftwareName (This will also appear on the menu) WARNING: The name should be the same as the folder containing this file 
    ...
    const id = 'net.nikachu.iframebrowser'; // ID (In the form of an android package name.)
    const url = `/application/${softwareName}/main.html` // view page
